...
<head>
    ...
    .rounded {
  border-radius: 10px;
  background: #D3D3D3; // without a background or border applied you won't be able to see if its rounded
}
    </style>
</head>
     ...
     <jsp:directive.include file="header.jsp" />
      <div id="wrapper">
        <div id="page-wrapper2" class="gray-bg">
           <div id="messagePrepender" class="rowx wrapper border-bottom white-bg page-heading rounded">
             <div class="col-sm-6">
                    <h2>Help Center</h2>
                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="">
                        <div class="row">
                            ...
                            Needed Help:Contact to vishwayan Technologies
